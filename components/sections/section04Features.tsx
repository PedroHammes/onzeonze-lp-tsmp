    ...
    return(
        <section className='relative flex flex-col gap-4 items-center justify-center px-8 '>
            ...
            <div className="flex flex-col">
                ...
                <p className="font-sans text-foreground text-base mt-4">Um espaço dedicado a armazenar os relatórios das redes sociais.</p>
                <p className="font-sans text-foreground text-base mt-4">_Relatórios mensais</p>
